...
\fboxrule0.1em\fboxsep0.5em
\fcolorbox{gray}{black!10}{
\begin{minipage}{10cm}
Peer-reviewed short paper at the \textbf{`r conf_number` AGILE International Conference on Geographic Information Science} `r params$year` in `r conf_place`. \\
\tiny\raggedright
Conference proceedings: \href{`r conf_url`}{`r conf_url`} \\
Self-archived with permission: \href{https://agile-online.org/conference/proceedings}{https://agile-online.org/conference/proceedings}
\end{minipage}
}
